...
public class OrderViewActivity extends AppCompatActivity implements OrderAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(OrderViewActivity.this,RegisterOrder.class));
            }
        });
    }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            OrderAdapter adapter = new OrderAdapter(OrderViewActivity.this, productList);
                            recyclerView.setAdapter(adapter);

                            OrderAdapter.setOnItemClickListener(OrderViewActivity.this);
